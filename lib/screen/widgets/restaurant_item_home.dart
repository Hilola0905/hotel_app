...
class RestaurantItemHome extends StatelessWidget {
  const RestaurantItemHome({super.key, required this.restaurantModel, required this.funk, });
            ...
            Stack(
              children: [
                ClipRRect(
                    ...
                    child: Image.network(restaurantModel.images[0],width: 130.w,height: 120.h,fit: BoxFit.cover,)
                ),
